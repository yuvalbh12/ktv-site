...
export default async function BuildingCleaningPage({ params }: { params: Promise<{ city: string }> }) {
  try {
    ...
    const message = `היי KTV, הגעתי מהאתר. אני מעוניין בניקוי בניינים ב${city}. אפשר לקבל פרטים?`;
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-purple-100">
                ...
                <h4 className="font-bold text-purple-900 mb-3">SelfCleaner™</h4>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-purple-100">
                ...
                <h4 className="font-bold text-purple-900 mb-3">KTV Care</h4>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-purple-100">
                <div className="text-3xl mb-4">🚁</div>
                <h4 className="font-bold text-purple-900 mb-3">ניקוי בגובה רב</h4>
                <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="relative group overflow-hidden rounded-xl">
                <div className="aspect-video bg-gradient-to-br from-pink-100 to-pink-200 flex items-center justify-center">
                  <span className="text-6xl text-pink-500">🏛️</span>
                </div>
                <div className="absolute bottom-0 left-0 right-0 bg-black/70 text-white p-3 text-center">
              ...
              <div className="relative group overflow-hidden rounded-xl">
                <div className="aspect-video bg-gradient-to-br from-indigo-100 to-indigo-200 flex items-center justify-center">
                  <span className="text-6xl text-indigo-500">☀️</span>
                </div>
                <div className="absolute bottom-0 left-0 right-0 bg-black/70 text-white p-3 text-center">
