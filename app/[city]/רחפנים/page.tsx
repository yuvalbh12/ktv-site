          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-indigo-100">
                ...
                <h4 className="font-bold text-indigo-900 mb-3">SelfCleaner™</h4>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-indigo-100">
                ...
                <h4 className="font-bold text-indigo-900 mb-3">KTV Care</h4>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-indigo-100">
                <div className="text-3xl mb-4">🚁</div>
                <h4 className="font-bold text-indigo-900 mb-3">ניקוי בגובה רב</h4>
                <p className="text-slate-600 text-sm leading-relaxed">
